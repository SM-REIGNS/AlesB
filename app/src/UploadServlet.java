...
public class UploadServlet extends HttpServlet {
   ...
   if( !isMultipart ) {
      ...
      factory.setRepository(new File("C:/Users/SHUBHAM MAITY/Desktop/upload"));
      ...
      try { 
         ...
         while ( i.hasNext () ) {
            ...
            if ( !fi.isFormField () ) {
              ...
              File f = new File("C:/Users/SHUBHAM MAITY/Desktop/emb/"+fileName.split(".")+".png");
      ...
      public void encrypt(File f1) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IOException {
			...
			byte[] key1="iamshubhamempire".getBytes();
			...
			FileOutputStream fin=new FileOutputStream(new File("C:/Users/SHUBHAM MAITY/Desktop/emb/aes_en.jpg"));
			int i; 
